...
then
# UBUNTU
        wget -q https://download.01.org/intel-sgx/sgx-dcap/$DCAP_VERSION/linux/tools/SGXMultiPackageAgent/$OS_FLAVOUR-server/debian_pkgs/libs/libsgx-ra-uefi/libsgx-ra-uefi_1.8.100.2-bionic1_amd64.deb -P $SGX_AGENT_BIN_DIR || exit 1
fi
